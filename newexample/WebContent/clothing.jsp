...
<head>
	...
	<link href="clothcss/NewFile1.css" rel='stylesheet' type='text/css'>

	<link rel="stylesheet" href="clothcss/reset.css"> <!-- CSS reset -->
	<link rel="stylesheet" href="clothcss/style.css"> <!-- Resource style -->
	<script src="clothjs/modernizr.js"></script> <!-- Modernizr -->
	...
	<ul class="cd-gallery">
			...
			<div class="cd-single-item">
				<a href="#0">
					<ul class="cd-slider-wrapper">
						<li><img src="img/b2.jpg" alt="Preview image" name="1"></li>
						<li class="selected"><img src="img/b2.jpg" alt="Preview image" name="2"></li>
				...
				<div class="cd-customization">
					...
					<button class="add-to-cart"><a href="addtocart"></a>
						<em>Add to Cart</em>
		...
		<li>
			<div class="cd-single-item">
				<a href="#0">
					<ul class="cd-slider-wrapper">
						<li class="selected"><img src="img/p1.jpeg" alt="Preview image"></li>
		...
		<li>
			<div class="cd-single-item">
				<a href="#0">
					<ul class="cd-slider-wrapper">
						<li><img src="img/b2.jpg" alt="Preview image"></li>
						<li class="selected"><img src="b2.jpg" alt="Preview image"></li>
						<li><img src="b2.jpg" alt="Preview image"></li>
					</ul>
				</a>
		...
		<li>
			<div class="cd-single-item">
				<a href="#0">
					<ul class="cd-slider-wrapper">
						<li class="selected"><img src="img/b1.jpg" alt="Preview image"></li>
						<li><img src="img/b1.jpg" alt="Preview image"></li>
						<li><img src="img/thumb-3.jpg" alt="Preview image"></li>
					</ul>
				</a>
...
<script src="clothjs/jquery-2.1.4.js"></script>
<script src="clothjs/main.js"></script> <!-- Resource jQuery -->
</body>
</html>